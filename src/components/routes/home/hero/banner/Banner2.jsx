    ...
    <section className="  ">
      ...
      <div className=" text-white py-15 bg-gradient-to-br from-[#632ee3] to-[#985cf0]">
        ...
        <div className="flex justify-center gap-10 items-center flex-wrap w-[80dvw] mx-auto mt-10">
          <div className="flex flex-col justify-center items-center border p-3 rounded-md min-w-[280px]">
          ...
          <div className="flex flex-col justify-center items-center border p-3 rounded-md min-w-[280px]">
            <h3 className="text-sm">Total Reviews:</h3>
            <p className="text-[clamp(1.8rem,3.8dvw,3.4rem)] font-bold">906K</p>
            <h3>46% more than last month</h3>
          </div>
          <div className="flex flex-col justify-center items-center border p-3 rounded-md min-w-[280px]">
            <h3 className="text-sm">Active Apps:</h3>
            <p className="text-[clamp(1.8rem,3.8dvw,3.4rem)] font-bold">132+</p>
